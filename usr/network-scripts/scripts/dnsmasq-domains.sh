...
#DNS_ISP=198.51.100.11
#DNS_ISP=198.51.100.12
#DNS_ISP=198.51.100.13
#DNS_ISP=192.0.2.5
#DNS_ISP=198.51.100.9
DNS_ISP=8.8.4.4
DNS_GOOGLE=8.8.8.8
...
#wget -4qO- http://hosts.mwsl.org.cn/hosts | sed '1,9d;s/198.51.100.8/127.0.0.1/g' > /etc/dnsmasq.hosts
